        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a href="https://www.instagram.com/healix_technologies/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-[#ea580c] transition-colors p-2.5 bg-white/5 rounded-full border border-white/5 hover:border-[#ea580c]/30" title="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
