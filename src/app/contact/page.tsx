...
export default function ContactPage() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] bg-white text-zinc-900 selection:bg-yellow-500/20 flex flex-col justify-between pt-20">
      {/* Page Content Container */}
      <div className="max-w-[94%] mx-auto px-6 sm:px-8 w-full flex-1 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <GlassCard variant="light" className="flex items-start gap-4 p-6 bg-zinc-50 border border-zinc-200 rounded-2xl shadow-sm" glowOnHover={false}>
              <div className="p-3 bg-[#ea580c]/10 rounded-xl border border-[#ea580c]/20">
                <MapPin className="h-5 w-5 text-[#ea580c]" />
              </div>
              <div>
                <h3 className="text-sm font-black font-mono uppercase text-zinc-900 mb-2">Location</h3>
            ...
            <GlassCard variant="light" className="flex items-start gap-4 p-6 bg-zinc-50 border border-zinc-200 rounded-2xl shadow-sm" glowOnHover={false}>
              ...
              <div>
                <h3 className="text-sm font-black font-mono uppercase text-zinc-900 mb-2">Phone No.</h3>
                <p className="text-xs text-zinc-650 leading-relaxed">
                  +91 9540694581
                </p>
              </div>
            ...
            <GlassCard variant="light" className="flex items-start gap-4 p-6 bg-zinc-50 border border-zinc-200 rounded-2xl shadow-sm" glowOnHover={false}>
              ...
              <div>
                <h3 className="text-sm font-black font-mono uppercase text-zinc-900 mb-2">Email Address</h3>
                <p className="text-xs text-zinc-650 leading-relaxed">
      ...
      {/* Chennai Skyline end-to-end footer accent */}
      <div className="w-full block overflow-hidden select-none pointer-events-none mt-auto">
        <img 
          src="/lupens/chennai_skyline_custom.png" 
          alt="Chennai Skyline" 
